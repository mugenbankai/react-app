      ...
      <div className="flex-1">
        <div className="flex justify-between mb-4 text-base sm:text-2xl">
          ...
          <select
            ...
            id=""
          >
            <option value="relavent">Filtrer par: Relavent</option>
            <option value="low-high">Filtrer par: Low to High</option>
            <option value="high-low">Filtrer par: High to Low</option>
          </select>
        </div>
